...
namespace AlgoSolution.Algorithms.DonchianBreakout.DonchianBreakoutClassic
{
    public class DonchianBreakoutClassic_OF : AlgorithmBase
    {
        ...
        public DonchianBreakoutClassic_OF(ITextFileRepositoryFactory textFileRepositoryFactory, IDataBaseRepositoryFactory dataBaseRepositoryFactory) : base(textFileRepositoryFactory, dataBaseRepositoryFactory)
        {
        }
    }
}
