...
namespace AlgoSolution.Algorithms.AdaptivePCEr.AdaptivePCErMiddle
{
    public class AdaptivePCErMiddle_OF : AlgorithmBase
    {
        ...
        public AdaptivePCErMiddle_OF(ITextFileRepositoryFactory textFileRepositoryFactory, IDataBaseRepositoryFactory dataBaseRepositoryFactory) : base(textFileRepositoryFactory, dataBaseRepositoryFactory)
        {
        }
    }
}
